        ...
        NetworkManager.shared.getUserInfo(for: username) { [weak self] result in
            ...
            case .success(let user):
                ...
                PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
                    ...
                    self.presentGFAlertOnMainThread(title: "Something went wrong.", message: error.rawValue, buttonTitle: "Ok") // update error
                }
                
            case .failure(let error):
                self.presentGFAlertOnMainThread(title: "Something went wrong", message: error.rawValue, buttonTitle: "Ok") // network error
            }
        }
    }
}
...
/// UISearchController Delegate Conformance
